...
{
    [KernelFunction]
    [Description("Get all GetBookingsMissingHotelRooms.")]
 ...
 [KernelFunction]
    [Description("Get all GetBookingsWithMultipleHotelRooms.")]
public async Task<IEnumerable<Booking>> GetBookingsWithMultipleHotelRooms()
    ...
    /// </summary>
    [KernelFunction]
    [Description("Get all GetBookingsByHotelAndMinimumDate.")]
